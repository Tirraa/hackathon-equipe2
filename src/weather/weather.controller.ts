...
export class WeatherController {
  ...
  async getSolarGraph(@Query() query: WeatherRequestDto) {
    ...
    graphRequest.start = "2024-03-01T14:21:41.499Z";
    graphRequest.end = "2024-03-10T14:21:41.499Z";
  ...
  async getRainGraph(@Query() query: WeatherRequestDto) {
    const graphRequest  = GraphRequestDto.mapFromWeatherRequest(query)
    graphRequest.start = "2023-03-01T14:21:41.499Z";
    graphRequest.end = "2023-03-10T14:21:41.499Z";
